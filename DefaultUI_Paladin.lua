...
local L = LibStub("AceLocale-3.0"):GetLocale("DefaultUI_Paladin")
local GetWoWVersion = ((select(4, GetBuildInfo())))
--local texturepackCheck    = "1.0.1.7"
--local texturepackDate     = "26/11/20"
local f = CreateFrame("Frame", "DefaultUI_Paladin_Config", UIParent)
f:SetSize(50, 50)
f:RegisterEvent("PLAYER_LOGIN")
f:SetScript("OnEvent", function(self, event, ...)
  character = UnitName("player").."-"..GetRealmName()
  -- Config/Panel
  if not DefaultUI_Paladin_Config then
    local DefaultUI_Paladin_Config = {}
  end
  -- Color Init
...
local dialogFrameTexture 		= "Interface\\Addons\\DefaultUI_Paladin\\textures\\extra\\dialogFrameTexture"
...
BasicFrames:SetScript("OnEvent", function(self, event, addon)
	if (addon == "DefaultUI_Paladin") then
		for i, v in pairs({	
			PlayerFrameTexture,
...
AbyssUISave:SetScript("OnEvent", function(self, event, arg1)
	if (event == "ADDON_LOADED" and arg1 == "DefaultUI_Paladin") then
